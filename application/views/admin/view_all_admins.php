                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                        ...
                                        if($this->model_admin->get_all_admins()){
                                            $user_data=$this->model_admin->get_all_admins();
                                            $id=0;
                                                ?>
                                    ...
                                    <tbody>
                                        <?php
                                            foreach ($user_data as $admin_info){
                                                $id=$id+1;
//                                                echo $astrologer_info['email'];
                                                ...
                                                <tr class="odd gradeX">
                                                    <td><?php echo $id; ?></td>
                                                    <td> <img style=" height: 90px; width: 90px;border-radius: 50%;"  src="<?php echo base_url('uploads/profile_pictures/'.$admin_info['img_url']); ?>"></td>
                                                    <td><?php echo $admin_info['first_name']." ".$admin_info['last_name']; ?></td>
                                                    <td class="center"><?php echo $admin_info['email']; ?></td>
                                                    <td class="center"><?php echo $admin_info['phone']; ?></td>
                                                    <td><?php echo $admin_info['gender']; ?></td>
                                                    <td>  <?php echo $admin_info['home_town']; ?></td>
                                                    <td> 5yr<?php // echo $user_info['expierence']; ?></td>
                                                    <td style="text-align: center">
                                                        <a href="<?php echo site_url('./admin/admin/edit_all/'.$admin_info['id']); ?>">
                                                            <i class="fa fa-pencil-square-o" aria-hidden="true" style="padding: 0 10px"></i>
                                                        </a>  
                                                        <a href="<?php echo site_url('./admin/admin/delete_admin/'.$admin_info['id']); ?>">
