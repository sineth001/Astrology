...
font-size: 16px;">Last access : 03 Oct 2017 &nbsp; <a href="<?php echo site_url('./login/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a></div>
		...
		<!--------------------------------------------------------------------------------------->
                ...
                <!--astrologer-->
                   ...
                   <li>
                       <a class="active-menu"  href="<?php echo site_url('./admin/admin/all_posts'); ?>"><i class="fa fa-desktop fa-3x"></i> All posts</a>
                    </li>
                    <li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             All post that the destinyZ have
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                        ...
                                        if($this->model_admin->get_all_posts()){
                                            $post_data=$this->model_admin->get_all_posts();
                                            $id=0;
                                                ?>
                                    ...
                                    <tbody>
                                        <?php
                                            foreach ($post_data as $post_info){
                                                $user_info=$this->model_admin->get_user_for_post($post_info['user_id']);
                                                $id=$id+1;
//                                                echo $astrologer_info['email'];
                                                ...
                                                <tr class="odd gradeX">
                                                    <td><?php echo $id; ?></td>
                                                    <td><img style=" height: 90px;" src="<?php echo base_url('uploads/posts/'.$post_info['img_url']); ?>" ></td>
                                                    <td><?php echo $post_info['post_title']; ?></td>
                                                    <td class="center"><?php echo $post_info['post_content']; ?></td>
                                                    ...
                                                    <td style="text-align: center"> 
                                                        <a href="<?php echo site_url('./admin/admin/delete_post/'.$post_info['post_id']); ?>"><i class="fa fa-trash-o" aria-hidden="true" style="padding: 0 10px"></i></a>
                                                    </td> 
                                                </tr>
                                                <?php
                                            }
