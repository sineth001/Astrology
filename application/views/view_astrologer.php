...
<body>
    ...
    <div style="width: 60% ; margin: auto;">
        ...
        <!--form-- ------------------>
            ...
            <form class="form" action="<?php echo site_url('astrologer') ?>" method="post" >


                <div class="form-group">
                    <div class="row form-error" style="height : 21px;">
                        <?php echo form_error('name_of_service'); ?>
                    </div>
                    <label class="label-style" >Name of Service </label>
                    <input type="text" name="name_of_service" placeholder="Name of Service"  value="<?php echo set_value('name_of_service'); ?>" class=" form-style form-control "  style=" ">
                ...
                <div class="form-group">
                    ...
                    <label  class="label-style">Your Experience </label>
                    <input type="text" name="experience" placeholder="Experience"  value="<?php echo set_value('experience'); ?>" class="form-style form-control  " style=" ">
                </div>
