...
class home extends CI_Controller{
    ...
    function __construct() {
        ...
        $this->load->library('form_validation');
         ...
         if(empty($this->session->userdata('email'))||$this->session->userdata('user_type')!='user'){
            redirect('login');
        }
    }
...
//            $this->load->view('./user/view_profile');
    ...
    public function time_line(){
        $this->load->view('./user/view_time_line');
    }
    public function about(){
        $this->load->view('./user/view_about');
    }
    public function followers(){
        $this->load->view('./user/view_followers');
    }
    public function freinds(){
        $this->load->view('./user/view_freinds');
    }
    public function photos(){
        $this->load->view('./user/view_photos');
    }
    ...
    public function make_comments($post_id){
        ...
        if($_POST){
            $this->form_validation->set_rules('comment_contentt', 'Comment', 'trim');
