        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     ...
                     <h5>Welcome <?php echo $_SESSION['first_name'].' '.$_SESSION['last_name'];?> , Love to see you back. </h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
			...
			<div class="panel panel-back noti-box">
                <span class="icon-box bg-color-red set-icon">
                    <i class="fa fa-envelope-o" style="padding: 19%;"></i>
                </span>
                <div class="text-box" >
			...
			<div class="panel panel-back noti-box">
                <span class="icon-box bg-color-green set-icon">
                    <i class="fa fa-bars" style="padding: 19%;"></i>
                </span>
                <div class="text-box" >
			...
			<div class="panel panel-back noti-box">
                <span class="icon-box bg-color-blue set-icon">
                    <i class="fa fa-bell-o" style="padding: 19%;"></i>
                </span>
                <div class="text-box" >
			...
			<div class="panel panel-back noti-box">
                <span class="icon-box bg-color-brown set-icon">
                    <i class="fa fa-rocket" style="padding: 19%;"></i>
                </span>
                <div class="text-box" >
                    <p class="main-text">New users</p>
                    <p class="text-muted">Have started</p>
                </div>
             </div>
		     </div>
			</div>
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">           
                     <div class="panel panel-back noti-box">
                        <span class="icon-box bg-color-blue" >
                            <i class="fa fa-warning" style="padding: 19%;"></i>
                        </span>
                        <div class="text-box" >
          ...
          <div class="main-temp-back">
            <div class="panel-body">
              <div class="row">
                <div class="col-xs-6"> <i class="fa fa-cloud fa-3x"></i> Kandy city </div>
                <div class="col-xs-6">
                  <div class="text-temp"> 10° </div>
                     ...
                     <div class="panel panel-back noti-box">
                <span class="icon-box bg-color-green set-icon">
                    <i class="fa fa-desktop" style="padding: 19%;"></i>
                </span>
                <div class="text-box" >
