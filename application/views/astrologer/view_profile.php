...
<div class=" container-fluid body-wrapper" style=" font-family: cursive;">
    ...
    <div class="row border-style" style="height: 500px ; margin-bottom: 38px;">
        ...
        <!--Make a post are--------------------->
        <div class="col-lg-6 border-style" style=" height: 484px; ">
            <div style="    color: gray; ">
            <div class="post-wrapper" style="padding: 47px; box-shadow: 1px 1px 27px #c0c0c0; background-color: #fff; ">
    ...
    <div class="row border-style" style="">
        ...
        <!--post area--------------------------------------------------------------------------------------------------------------------------------->  
        <div class="col-lg-5 comment-area" style=" " class="">
        <?php
        ...
        if($this->model_post->get_all_post()){
            ...
            <div class="row border-style" style="box-shadow: 4px 5px 14px 2px #c0c0c0; margin-bottom: 40px;" >
                ...
                <div class=" border-style" style="height: 70px;  color: gray; background-color: white;">
                            ...
                            <?php
                                ...
                                if($this->model_system_user->get_user_by_id($post_info['user_id'])){
                                    ...
                                    <img style="height: 70px; width: 70px;border-radius: 0px 25px 0px 25px; padding: 6px;"  src="<?php echo base_url('uploads/profile_pictures/'.$user_info['img_url']); ?>">
                    ...
                    <!--<img src="<?php // echo base_url('uploads/profile_pictures'.$post_info['img_url']) ?>" style="height: 70px; width: 70px;">-->
                                    ...
                                    <span style="padding-left: 33px">
                                        ...
                                        AT <?php echo $post_info['added_time']; ?>
                                    ...
                                    <?php
                                     ...
                                     ?>
                                        ...
                                        <a href="<?php echo site_url('./astrologers/home/delete_a_post/'.$post_info['post_id']); ?>">
                ...
                <!--post title-->
                <div class=" border-style" style="height: 70px; background-color: #ea4335 ;color: white;">
...
<!--                    <a href="" style="padding-left: 20px;">
                    ...
                    <?php
                        ...
                        if(!empty($this->model_post->check_liked($post_info['post_id']))){
                            ...
                            ?>
                                ...
                                <a href="<?php echo site_url('./astrologers/home/'.$like_data['function'].'/'.$post_info['post_id']); ?>" 
            ...
            <div style="color: gray">
                ...
                <span style="padding: 10px;">
                    <?php echo $this->model_comment->get_number_of_comments_for_a_post($post_info['post_id']) ?>
...
<!--                <span style="padding: 10px;" >
            ...
            <div id="<?php echo $post_info['post_id']  ?>" class="comments-list border-style" style="width: 96%; margin: auto; border: 4px solid #F2EDED; margin-bottom: 17px; background-color: white;">
                ...
                <div> <p style="padding-top: 25px;">Make a comment </p>
                    ...
                    <form id="formoid" class="formoid" action="<?php // echo site_url('./users/home/make_comments/'.$post_info['post_id']); ?>" method="post">
                        <div class="form-group">
                            ...
                            <textarea class=" form-style form-control " id="comment_content"   name="comment_content"></textarea>
                        </div>
    ...
    //                getting comments for the post
                    ...
                    ?>
                            ...
                            <div class=" border-style" style="height: 50px; background-color: #ea4335; border-radius: 0px 25px 0px 0px;color: white;">
                                <img style="height: 50px; width: 50px;"  src="<?php echo base_url('uploads/profile_pictures/'.$user_info_for_comments['img_url']); ?>">
                                <span><?php echo $user_info_for_comments['first_name'].' '.$user_info_for_comments['last_name']; ?> @ <?php echo $comment_info['added_time']; ?></span>

                            </div>
                            <div  class=" border-style" style=" padding: 10px; border:4px solid #ea4335; border-radius: 0px 0px 0px 20px;margin: 4px 0px 10px 33px;">
                                <p style="padding-left: 22px;">
                                    ...
                                    <?php
                                     ...
                                     ?>
                                        ...
                                        <a href="<?php echo site_url('./astrologers/home/delete_a_comment/'.$comment_info['comment_id']); ?>">
