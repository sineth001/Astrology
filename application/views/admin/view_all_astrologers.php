    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">DestinyZ admin</a> 
            </div>
		...
		<!--------------------------------------------------------------------------------------->
                ...
                <!--astrologer-->
                    <li>
                        ...
                        <a class="active-menu" href="<?php echo site_url('./admin/admin/all_astrologers'); ?>"><i class="fa fa-users fa-3x"></i>View All Astrologers</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <?php
                                        ...
                                        if($this->model_admin->get_all_astrologers()){
                                            $astrologer_data=$this->model_admin->get_all_astrologers();
                                            $id=0;
                                                ?>
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            foreach ($astrologer_data as $astrologer_info){
                                                
                                                $astrologer_more=$this->model_admin->get_astrologer_more_info_by_id($astrologer_info['id']);
                                                $id=$id+1;
//                                                echo $astrologer_info['email'];
                                                ...
                                                <tr class="odd gradeX">
                                                    <td><?php echo $id; ?></td>
                                                    <td> <img style=" height: 90px; width: 90px;border-radius: 50%;"  src="<?php echo base_url('uploads/profile_pictures/'.$astrologer_info['img_url']); ?>"></td> 
                                                    <td><?php echo $astrologer_info['first_name']." ".$astrologer_info['last_name']; ?></td>
                                                    <td class="center"><?php echo $astrologer_info['email']; ?></td>
                                                    <td class="center"><?php echo $astrologer_info['phone']; ?></td>
                                                    <td><?php echo $astrologer_info['gender']; ?></td>
                                                    <td> <?php echo $astrologer_more['name_of_service']; ?></td>
                                                    <td><?php echo $astrologer_more['experience']; ?></td>
                                                    <td style="text-align: center">
                                                        <a href="<?php echo site_url('./admin/admin/edit_all/'.$astrologer_info['id']); ?>">
                                                            <i class="fa fa-pencil-square-o" aria-hidden="true" style="padding: 0 10px"></i>
                                                        </a>  
                                                        <a href="<?php echo site_url('./admin/admin/delete_astrologer/'.$astrologer_info['id']); ?>">
