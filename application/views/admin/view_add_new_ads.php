...
font-size: 16px;"> Last access : 03 Oct 2017 &nbsp; <a href="<?php echo site_url('./login/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
                ...
                <!--astrologer-->
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active-menu" href="<?php echo site_url('./admin/admin/add_new_ads'); ?>">Add new </a>
                            </li>
    ...
    <div class="row" style="width: 85% ; margin: auto;">
        ...
        <div style=" " class="col-lg-8 ">
            ...
            <?php echo form_open_multipart(site_url('.\admin\admin\do_upload'));?>    
            <!--<form class="form" action="<?php // echo site_url('./admin/admin/edit_info'); ?>" method="post" >-->
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" placeholder="Heading of the ad"  value="<?php echo set_value('title'); ?>" class=" form-style form-control "  style=" ">
                ...
                <div class="form-group">
                    ...
                    <textarea class=" form-style form-control " name="content"><?php echo set_value('content'); ?></textarea> 
                </div>
