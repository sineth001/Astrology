...
<body>
  ...
  <div style="color: white;padding: 15px 50px 5px 50px;float: right;font-size: 16px;">
      Last access : 03 Oct 2017 &nbsp; <a href="<?php echo site_url('./login/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a>
  </div>
        </nav>   
           <!-- /. NAV TOP  -->
		...
		<!--------------------------------------------------------------------------------------->
                ...
                <!--astrologer-->
                    ...
                    <li>
                        ...
                        <a class="active-menu"  href="<?php echo site_url('./admin/admin/all_users'); ?>"><i class="fa fa-user fa-3x"></i>View All User</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                        ...
                                        if($this->model_admin->get_all_users()){
                                            $user_data=$this->model_admin->get_all_users();
                                            $id=0;
                                                ?>
                                    ...
                                    <tbody>
                                        <?php
                                            foreach ($user_data as $user_info){
                                                ...
                                                $user_more=$this->model_admin->get_user_more_info_by_id($user_info['id']);
                                                $id=$id+1;
                                                ?>
                                                ...
                                                <tr class="odd gradeX">
                                                    <td><?php echo $id; ?></td>
                                                    <td> <img style=" height: 90px; width: 90px;border-radius: 50%;"  src="<?php echo base_url('uploads/profile_pictures/'.$user_info['img_url']); ?>"></td>
                                                    ...
                                                    <td>  <?php echo $user_info['home_town']; ?></td>
                                                    <td> <?php echo $user_more['zodiac']; ?></td>
                                                    <td style="text-align: center">
                                                        <a href="<?php echo site_url('./admin/admin/edit_all/'.$user_info['id']); ?>">
                                                            <i class="fa fa-pencil-square-o" aria-hidden="true" style="padding: 0 10px"></i>
                                                        </a>  
                                                        <a href="<?php echo site_url('./admin/admin/delete_user/'.$user_info['id']); ?>">
