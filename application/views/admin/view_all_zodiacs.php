...
//                                                echo $astrologer_info['email'];
                                                ...
                                                <tr class="odd gradeX">
                                                    <td><?php echo $id; ?></td>
                                                    <td> 
                                                        <img style="height: 100px;" src="<?php echo base_url('css/images/zodiac/'.$zodiac_info['img_url']); ?>">
                                                    </td>
                                                    <td><?php echo $zodiac_info['zodiac_name']; ?></td>
                                                    <td class="center"><?php echo $zodiac_info['description']; ?></td>
                                                    <td class="center"><?php echo $zodiac_info['updated_time']; ?></td>
                                                    <td style="text-align: center">
                                                        <a href="<?php echo site_url('./admin/admin/edit_zodiac/'.$zodiac_info['id']); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true" style="padding: 0 10px"></i></a>  
